...
public class Main {
    public static void main(String[] args) {
        ...
        employees[0] = new Employee("Иван Иванов", "Руководитель", "+7 (987) 123-45-67", 50000, 35);
        employees[1] = new Employee("Петр Петров", "Программист", "+7 (987) 234-56-78", 40000, 40);
        employees[2] = new Employee("Анна Сидорова", "Бухгалтер", "+7 (987) 345-67-89", 35000, 50);
        employees[3] = new Employee("Ольга Козлова", "Менеджер", "+7 (987) 456-78-90", 30000, 55);
        employees[4] = new Employee("Дмитрий Егоров", "Аналитик", "+7 (987) 567-89-01", 45000, 30);
        employees[5] = new Supervisor("Елена Петрова", "Генеральный директор", "+7 (987) 678-90-12", 100000, 45);
        ...
        Supervisor.increaseSalary(employees, 45, 5000);
